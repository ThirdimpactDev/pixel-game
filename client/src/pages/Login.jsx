...
const Login = () => {
  useEffect(() => {
    const setupPixels = () => {
      ...
      const colors = ['#2d8cf0', '#87CEEB', '#ADD8E6', '#B0E0E6', '#87CEFA'];
  ...
  return (
    <>
      ...
      <form className="form">
        <div className="title">
          Welcome,<br />
          <span>Muh brotha! Please log in with Google to access limitless fun!</span>
        </div>
        <div className="login-with">
          <div className="button-log" onClick={handleGoogleLogin}>
            <svg xmlns="http://www.w3.org/2000/svg" width="56.6934px" height="56.6934px" viewBox="0 0 56.6934 56.6934" className="icon">
